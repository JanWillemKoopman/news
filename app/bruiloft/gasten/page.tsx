...
function RsvpSelect({
  ...
  return (
    <select
      ...
      className={`rounded-full px-1.5 py-0.5 text-[10px] sm:px-2.5 sm:text-xs font-medium ring-1 ring-inset focus:outline-none focus:ring-2 focus:ring-ring transition-opacity ${pending ? 'cursor-wait opacity-50' : 'cursor-pointer'} ${klassen[value]}`}
    >

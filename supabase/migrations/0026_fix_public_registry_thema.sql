-- Fix: get_public_registry verwees voor thema/kleur/lettertype/headerfoto naar
-- registry_settings, maar die kolommen leven op website_content. Daardoor gaf
-- de publieke cadeaulijst-pagina een databasefout ("column thema does not exist").
-- De vormgeving wordt nu — net als op de trouwwebsite zelf — uit website_content gelezen.

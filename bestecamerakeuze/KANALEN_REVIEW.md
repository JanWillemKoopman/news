...
| B8 | ~~**Kanalen naast elkaar.**~~ Gebouwd als schakelaar "Alle betaalde kanalen" en in september 2026 op verzoek weer verwijderd: op de pagina Google Ads verschenen daardoor Meta- en LinkedIn-regels onder een filter "Kanaal", terwijl de kop Google Ads bleef. Elke pagina toont nu alleen zijn eigen kanalen. Een vergelijking over kanalen heen hoort in de chat, of in een eigen tabblad dat zich ook zo noemt. | — | Vervallen |

...
export function MobileNav() {
  ...
  return (
    <>
      <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-white pb-[env(safe-area-inset-bottom)] shadow-[0_-1px_3px_rgba(15,23,42,0.04)] [transform:translateZ(0)] md:hidden">

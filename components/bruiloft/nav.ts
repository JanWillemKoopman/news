...
const documenten: NavItem = { label: 'Documenten', href: '/bruiloft/documenten', icon: FolderOpen, module: 'documenten' }
...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    icon: ClipboardList,
    href: '/bruiloft/taken',
    items: [taken, budget, draaiboek, muziek, moodboard, documenten],
    module: 'taken',
  },
  {
    key: 'leveranciers',

...
const STAGES: { stage: IterationStage; label: string; icon: typeof PenLine }[] = [
  ...
  { stage: 'humanizing1', label: 'Variant 1 verfijnen', icon: Wand2 },
  { stage: 'humanizing2', label: 'Variant 2 verfijnen', icon: Wand2 },
  { stage: 'humanizing3', label: 'Variant 3 verfijnen', icon: Wand2 },
]
...
const STAGE_ORDER: IterationStage[] = ['writing3', 'humanizing1', 'humanizing2', 'humanizing3', 'done']

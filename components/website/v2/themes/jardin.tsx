      ...
      <form onSubmit={b.submit} className="space-y-5 text-center">
        ...
        {b.komt && (
          <div className="space-y-4 text-left">
            ...
            <input value={b.verzoeknummer} onChange={(e) => b.setVerzoeknummer(e.target.value)} placeholder="Muziekwens: artiest — nummer (optioneel)" className="ja-veld" />
            <input value={b.bericht} onChange={(e) => b.setBericht(e.target.value)} placeholder="Bericht voor het bruidspaar (optioneel)" className="ja-veld" />

        ...
        {b.komt && (
          <div className="space-y-6">
            ...
            <Veld label="Muziekwens — optioneel">
              <input value={b.verzoeknummer} onChange={(e) => b.setVerzoeknummer(e.target.value)} placeholder="Artiest — nummer" className="st-veld" />
            </Veld>
            <Veld label="Bericht voor het bruidspaar — optioneel">
              <input value={b.bericht} onChange={(e) => b.setBericht(e.target.value)} className="st-veld" />
            </Veld>
